...
/** Optional parameters. */
export interface DeleteSecretOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the deleteSecret operation. */
export type DeleteSecretResponse = DeletedSecretBundle;
/** Optional parameters. */
export interface UpdateSecretOptionalParams extends coreClient.OperationOptions {
    /** Type of the secret value such as a password. */
    contentType?: string;
    /** The secret management attributes. */
    secretAttributes?: SecretAttributes;
...
/** Optional parameters. */
export interface GetSecretVersionsOptionalParams extends coreClient.OperationOptions {
    /** Maximum number of results to return in a page. If not specified, the service will return up to 25 results. */
    maxresults?: number;
}
...
/** Optional parameters. */
export interface GetDeletedSecretsOptionalParams extends coreClient.OperationOptions {
    /** Maximum number of results to return in a page. If not specified the service will return up to 25 results. */
    maxresults?: number;
}
...
/** Optional parameters. */
export interface GetDeletedSecretOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the getDeletedSecret operation. */
export type GetDeletedSecretResponse = DeletedSecretBundle;
/** Optional parameters. */
export interface PurgeDeletedSecretOptionalParams extends coreClient.OperationOptions {
}
/** Optional parameters. */
export interface RecoverDeletedSecretOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the recoverDeletedSecret operation. */
export type RecoverDeletedSecretResponse = SecretBundle;
/** Optional parameters. */
export interface BackupSecretOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the backupSecret operation. */
export type BackupSecretResponse = BackupSecretResult;
/** Optional parameters. */
export interface RestoreSecretOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the restoreSecret operation. */
export type RestoreSecretResponse = SecretBundle;
/** Optional parameters. */
export interface GetSecretsNextOptionalParams extends coreClient.OperationOptions {
    /** Maximum number of results to return in a page. If not specified, the service will return up to 25 results. */
    maxresults?: number;
}
...
/** Optional parameters. */
export interface GetSecretVersionsNextOptionalParams extends coreClient.OperationOptions {
    /** Maximum number of results to return in a page. If not specified, the service will return up to 25 results. */
    maxresults?: number;
}
...
/** Optional parameters. */
export interface GetDeletedSecretsNextOptionalParams extends coreClient.OperationOptions {
    /** Maximum number of results to return in a page. If not specified the service will return up to 25 results. */
    maxresults?: number;
}
