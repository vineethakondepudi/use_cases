...
import { KeyVaultSecretPollOperation, KeyVaultSecretPollOperationState } from "../keyVaultSecretPoller.js";
...
export declare class DeleteSecretPollOperation extends KeyVaultSecretPollOperation<DeleteSecretPollOperationState, DeletedSecret> {
    ...
    constructor(state: DeleteSecretPollOperationState, vaultUrl: string, client: KeyVaultClient, operationOptions?: OperationOptions);
    /**
